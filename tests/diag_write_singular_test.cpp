	    ...
	    {
	        {
	            ...
	            {
	                {"path", 5, 2, severity::note, "an explanation",
	                 link_type::gcc, false, color::always},
	                {"path", 5, 2, severity::fatal, "terminal observation",
	                 link_type::gcc, false, color::always},
	            },
	        },
	        {
	            "\033[1mpath:6:3:\033[0m \033[1;35mwarning:\033[0m a message\n",
	            "\033[1mpath:5:2:\033[0m \033[1;36mnote:\033[0m an "
	            "explanation\n",
	            "\033[1mpath:5:2:\033[0m \033[1;31mfatal:\033[0m terminal "
	            "observation\n",
	        },
	        "\"a message\"s",
	    },
